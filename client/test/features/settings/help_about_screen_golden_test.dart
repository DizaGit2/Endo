...
/// Wraps [HelpAboutScreen] in a self-contained, size-bounded [MaterialApp] for
/// use in golden tests.
...
void main() {
  goldenTest(
    'HelpAboutScreen light theme',
    fileName: 'help_about_screen_light',
  ...
  goldenTest(
    'HelpAboutScreen dark theme',
    fileName: 'help_about_screen_dark',
    builder: () => GoldenTestGroup(
      columns: 1,
      children: [
        GoldenTestScenario(
