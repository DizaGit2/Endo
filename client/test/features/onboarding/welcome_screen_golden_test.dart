...
/// Wraps [WelcomeScreen] in a self-contained, size-bounded [MaterialApp] for
/// use in golden tests. [MediaQuery] is injected so Scaffold safe-area logic
/// resolves correctly inside Alchemist's bare test wrapper.
...
void main() {
  goldenTest(
    'WelcomeScreen light theme',
    fileName: 'welcome_screen_light',
  ...
  goldenTest(
    'WelcomeScreen dark theme',
    fileName: 'welcome_screen_dark',
    builder: () => GoldenTestGroup(
      columns: 1,
      children: [
        GoldenTestScenario(
