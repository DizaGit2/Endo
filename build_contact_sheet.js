...
.home-btn{font-size:13px;color:var(--mut);text-decoration:none;border:1px solid var(--bd);border-radius:8px;padding:6px 12px;transition:all .15s;white-space:nowrap;}
.home-btn:hover{color:var(--ac);border-color:var(--ac);}
