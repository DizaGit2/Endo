...
**NEXT PHASE TO RUN: P3c — Consolidation & hardening (new in r13; gates P4a).**  (P0a, P1, P2, P3a, **P3b DONE** — P3b was merged 2026-06-15 via PR #2 as a **fast-forward**; the ledger flip, `phase-03b` tag, and `--no-ff` merge commit were all missed. Repaired r13 (2026-07-06): ledger flipped, tag cut retroactively at `6d122d4` (the PR tip), RUNBOOK §8 tightened to an atomic ritual. **Work the long-lead gates below in parallel with P3c** — the pre-P4a decision session, clinical outreach C-01..C-13, the Anthropic DPA, and legal L-01/L-02/L-04 are the schedule's real critical path.)
**Plan revision:** r13   **Repo HEAD when ledger last updated:** `main` @ `74189f6` (P3b + 4 post-merge client fixes; see P3b STATUS)
