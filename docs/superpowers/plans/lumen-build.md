...
**Plan revision:** r16   **Repo HEAD when ledger last updated:** `main` @ pre-P4a decision-session docs commit (2026-07-08); r16 = clinical-asks PO-interim session (2026-07-14, docs-only, pending commit)
